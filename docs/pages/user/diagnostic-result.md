...
Shows overall score, readiness label, mean subject %, per-subject band table (`.data-table`, stacked labeled rows on mobile), and answer review. Primary CTA continues to the dashboard (gate cleared after a `COMPLETED` submit).
